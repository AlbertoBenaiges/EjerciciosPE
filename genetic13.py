# File: genetic.py
# from chapter 13 of _Genetic Algorithms with Python_, an ebook
# available for purchase at http://leanpub.com/genetic_algorithms_with_python
#
# Author: Clinton Sheppard <fluentcoder@gmail.com>
# Repository: https://drive.google.com/open?id=0B2tHXnhOFnVkRW83QTRnamlqUGc
...
def _crossover(parentGenes, index, parents, get_fitness, crossover, mutate,generate_parent):
    ...
    if childGenes is None:# parent and donor are indistinguishable
