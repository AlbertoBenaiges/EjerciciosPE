...
# from chapter 14 of _Genetic Algorithms with Python_, an ebook
# available for purchase at http://leanpub.com/genetic_algorithms_with_python
#
# Author: Clinton Sheppard <fluentcoder@gmail.com>
# Repository: https://drive.google.com/open?id=0B2tHXnhOFnVkSm1DVWJiSzY5RTQ
...
def display(genes, startTime, fitness):
    timeDiff = datetime.datetime.now() - startTime
    print("{0}\t{1}\t{2}".format((' '.join(map(str, [i for i in genes]))),fitness, timeDiff))
...
class EquationGenerationTests(unittest.TestCase):
    ...
    def solve(self, operations, prioritizedOperations, optimalLengthSolution):
        ...
        def fnMutate(child):
            ...
            best = genetic13.get_best(fnGetFitness, None, optimalFitness, None, fnDisplay, fnMutate, fnCreate, maxAge=50)
